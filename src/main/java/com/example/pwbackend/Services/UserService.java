...
//            Optional<User> database_user = userRepository.getUserByUsername(fe_input.getUsername());
//
...
//                        .put("token", token)
//                        .put("userId", userRepository.getUserByUsername(fe_input.getUsername()).get().getId()).toString(),
//                        HttpStatus.OK);
//            }
//
//        }
